...
def polish_description(text: str) -> str:
    ...
    replacements = [
        ...
        (r'\bTying green line to a rusted spear gun\b', 'Tying green line to a rusted speargun shaft'),
        (r'\bpadel\b', 'paddle'),
        (r'\bSpear Fisheman\b', 'Spearfisherman'),
        (r'\biant sweetlips\b', 'giant sweetlips'),
        (r'Pacific Oceang\b', 'Pacific Ocean'),
        (r'\barounda\b', 'around a'),
